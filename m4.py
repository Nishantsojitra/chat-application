...
class login1:
    ...
    def signup(self,c1):
        ...
        if c!=3:
            ...
            cur.execute(s,v)
            print("thanks for signing in into whatsup chat box")
            a.sever1(self.name)
    ...
    def login(self,c1):
        ...
        print("     ")
        password1=input("enter your passward :- ")
        cur=c1.cursor()
    ...
    def sever1(self,n):
        ...
        while True:
            print("     ")
            print("     ")
            p=int(input("enter 1 to send msg\nenter 2 to send export your chat\nenter 3 to clear chat\nenter 4 to send img \nenter 5 to recive msg \nenter 6 to recive img \nenter 7 to exit"))
            if p==1:
                print("hello,hii")
                a.chat(n)
            elif p==2:
